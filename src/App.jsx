...
import heroImg from '../../2.jpeg';
import authorityImg from '../../3.jpeg';
import gallery1 from '../../4.jpeg';
import gallery2 from '../../6.jpeg';
import gallery3 from '../../8.jpeg';
import gallery4 from '../../9.jpeg';
...
const BookingModal = ({ isOpen, onClose, intent }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const text = `Bonjour ! Je souhaite ${intent}. \n\nVoici mes informations :\n- Nom : ${formData.name}\n- Profession : ${formData.role}\n- Email : ${formData.email}\n- Défi Principal : ${formData.challenge || 'N/A'}`;
    const encodedText = encodeURIComponent(text);
    window.open(`https://wa.me/21654558094?text=${encodedText}`, '_blank');
    onClose();
  };
    ...
    <div style={{
      ...
      <div className="modal reveal active" style={{
        ...
        <div className="text-center mb-12">
          <span className="overline">Dernière Étape</span>
          ...
          <p style={{fontSize: 'var(--fs-sm)', opacity: 0.8, maxWidth: '400px', margin: '0 auto'}}>
            Remplissez vos coordonnées ci-dessous. Vous serez redirigé vers notre chaîne WhatsApp sécurisée pour confirmer votre place.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group mb-8">
            <label className="form-label">Quel est votre plus grand défi actuel ? (Optionnel)</label>
            <textarea className="form-input" rows="2" placeholder="ex: Procrastination, Stress, Pensées envahissantes..." value={formData.challenge} onChange={e => setFormData({...formData, challenge: e.target.value})}></textarea>
          </div>
    ...
    <div className="relative">
      ...
      <section className="section-white pt-32 pb-32">
        <div className="container container-narrow text-center mb-16 reveal">
          ...
          <h2>Myriam Errais-Borges (MEB)</h2>
          <p className="mx-auto mt-6" style={{ textAlign: 'left' }}>
            ...
            <br/><br/>
            Née en 1972, Myriam Errais-Borges est une universitaire et une figure culturelle de premier plan, portée par une vocation profonde pour les arts, la culture et l'éducation. Docteure en Art et Civilisations de la Sorbonne Paris-4 (2004), elle a exercé des responsabilités majeures (Médecins Sans Frontières, Medina Mediterranea, PsF).
            <br/><br/>
            Auteure de plusieurs essais remarqués ("Confidences de Tunisie", "Les pouvoirs de la Culture en Tunisie", "La mosaïque de seuil", "Portraits d’Ames"), elle est aussi certifiée en gestion de projets culturels et en Energy Coaching & leadership (World Network Consulting Services). Aujourd'hui, elle poursuit son engagement au service de la culture et le bien être par l'enseignement, la recherche et l'écriture.
          </p>
        </div>
      ...
      <a 
        href="https://wa.me/21654558094?text=Bonjour,%20j'ai%20une%20question%20sur%20les%20sessions%20de%20cohérence." 
        target="_blank" 
